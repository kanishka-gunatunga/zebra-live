...
<div>
        <div>
            <h2 class="page-title">{{$star_rating->title}}</h2>
            <p class="page-description">{{$star_rating->short_description}}</p>
           <div class="flex-row">
    @for ($i = 0; $i < $star_rating->rating; $i++)
    ...
    @endfor
        ...
        <div class="col-lg-9 col-md-9 col-12 mt-5">
         ...
         <?php echo    $star_rating->description ?>
